...
**必要なIAM権限**: AdministratorAccess（または個別にS3, Lambda, API Gateway, DynamoDB, Step Functions, MediaConvert, Cognito, CloudFront, ECR, CloudWatch, SNS, IAM）
...
| GeminiModelName | Enter（デフォルト） | `gemini-2.5-pro` |
